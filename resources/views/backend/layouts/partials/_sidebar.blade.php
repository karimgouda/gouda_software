<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            @can('show projects')
                <li class="menu {{ is_active(['projects']) }}">
                    <a href="#projects" data-bs-toggle="collapse" aria-expanded="{{ is_true(['projects']) }}"
                        class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <ul class="collapse submenu list-unstyled {{ is_show(['projects']) }}" id="projects"
                        data-bs-parent="#accordionExample">
                        <li class="{{ is_active(['projects']) }}">
                            <a href="{{ route('projects.categories.index') }}"> {{ translate('categories') }} </a>
                        </li>
                        <li class="{{ is_active(['projects']) }}">
                            <a href="{{ route('projects.index') }}"> {{ translate('projects') }} </a>
                        </li>
            ...
            <li class="menu {{ is_active(['services']) }}">
                <a href="#services" data-bs-toggle="collapse" aria-expanded="{{ is_true(['services']) }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <ul class="collapse submenu list-unstyled {{ is_show(['services']) }}" id="services"
                    data-bs-parent="#accordionExample">
                    <li class="{{ is_active(['services']) }}">
                        <a href="{{ route('service_detail.index') }}"> {{ translate('service detail') }} </a>
                    </li>
                    <li class="{{ is_active(['services']) }}">
                        <a href="{{ route('services.index') }}"> {{ translate('services') }} </a>
                    </li>
            ...
            <li class="menu  {{ is_active(['service_request']) }}">
                <a href="{{ route('service_request.index') }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <span>{{ translate('service_request') }}</span>
                    </div>
            ...
            @can('show sliders')
                <li class="menu  {{ is_active(['sliders']) }}">
                    <a href="{{ route('sliders.edit') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-trello">
            ...
            @can('show clients')
                <li class="menu  {{ is_active(['clients']) }}">
                    <a href="{{ route('clients.index') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-layers">
            ...
            @can('show employees')
                <li class="menu  {{ is_active(['employees']) }}">
                    <a href="{{ route('employees.index') }}" class="dropdown-toggle">
                        <div class="">
            ...
            @can('show businesses')
                <li class="menu  {{ is_active(['businesses']) }}">
                    <a href="{{ route('businesses.index') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-briefcase" viewBox="0 0 16 16">
                                <path d="M6.5 1A1.5 1.5 0 0 0 5 2.5V3H1.5A1.5 1.5 0 0 0 0 4.5v8A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-8A1.5 1.5 0 0 0 14.5 3H11v-.5A1.5 1.5 0 0 0 9.5 1h-3zm0 1h3a.5.5 0 0 1 .5.5V3H6v-.5a.5.5 0 0 1 .5-.5zm1.886 6.914L15 7.151V12.5a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5V7.15l6.614 1.764a1.5 1.5 0 0 0 .772 0zM1.5 4h13a.5.5 0 0 1 .5.5v1.616L8.129 7.948a.5.5 0 0 1-.258 0L1 6.116V4.5a.5.5 0 0 1 .5-.5z"/>
                              </svg>
                            <span>{{ translate('businesses') }}</span>
                        </div>
            ...
            @can('show recruitments')
                <li class="menu  {{ is_active(['recruitments']) }}">
                    <a href="{{ route('recruitments.index') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-activity" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M6 2a.5.5 0 0 1 .47.33L10 12.036l1.53-4.208A.5.5 0 0 1 12 7.5h3.5a.5.5 0 0 1 0 1h-3.15l-1.88 5.17a.5.5 0 0 1-.94 0L6 3.964 4.47 8.171A.5.5 0 0 1 4 8.5H.5a.5.5 0 0 1 0-1h3.15l1.88-5.17A.5.5 0 0 1 6 2Z"/>
                              </svg>
                            <span>{{ translate('recruitments') }}</span>
                        </div>
            ...
            @can('show jobs')
                <li class="menu  {{ is_active(['jobs']) }}">
                    <a href="{{ route('jobs.index') }}" class="dropdown-toggle">
                        <div class="">
