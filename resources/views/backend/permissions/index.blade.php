...
@section('breadcrumb')
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ translate('permissions') }}</li>
        </ol>
    </nav>
@endsection
...
@section('content')
    <div class="widget row mt-5 mb-5 d-flex">
        <h4 class="col-6">{{ translate('permissions') }}</h4>
        <div class="col-6 text-end">
            <a href="{{ route('roles.permissions.create') }}" class="btn btn-primary  ">{{ translate('add_new_permission') }}</a>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="statbox  box box-shadow">
                <div class="widget-content widget-content-area p-3">
                    <form id="delete-form" action="{{ route('roles.permissions.destroy.all') }}" method="POST">
                        @csrf
