...
@section('breadcrumb')
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ translate('about_us') }}</li>
        </ol>
    </nav>
@endsection
    ...
    <div class="statbox widget box box-shadow layout-top-spacing">
        ...
        <div class="widget-content ">
            ...
            <div class="contact-us-form">
                ...
                <div class="row gx-5">
                    <div class="col-md-12">
                        <form class="row g-4" method="POST" action="{{ route('about_us.update') }}"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12">
                                <h5>{{translate('edit_about_us')}}</h5>
                            </div>
