...
@section('content')
    <div class="widget row mt-5 mb-5 d-flex">
        <h4 class="col-6">{{ translate('users') }}</h4>
        <div class="col-6 text-end">
            <a href="{{ route('users.create') }}" class="btn btn-primary  ">{{ translate('add_new_user') }}</a>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="statbox  box box-shadow">
                <div class="widget-content widget-content-area p-3">
                    <form id="delete-form" action="{{ route('users.destroy.all') }}" method="POST">
                        @csrf
