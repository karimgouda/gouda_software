<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
        <a class="dropdown-item" href="{{route('projects.categories.edit',$id)}}">{{translate('edit')}}</a>
        <form id="delete-form" action="{{ route('projects.categories.destroy', $id) }}" method="POST">
            @csrf
            @method('delete')
