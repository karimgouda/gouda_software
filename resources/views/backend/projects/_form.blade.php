<div class="col-xxl-9 col-xl-12 m-0 col-lg-12 col-md-12 col-sm-12">
    ...
    <div class="widget-content row widget-content-area blog-create-section">
        ...
        @foreach (App\Services\TranslatableService::getTranslatableInputs(App\Models\Project::class) as $name => $data)
            ...
            <div class="col-xxl-12 col-md-12 mb-4">
                ...
                <select id="select-category" name="categories[]" multiple placeholder="Select a categories..."
                    ...
                    @foreach ($categories as $category)
                        <option value="{{ $category->id }}" {{ ( isset($project_categories) && in_array($category->id,$project_categories->pluck('id')->toArray())) ? 'selected' : '' }}> {{ $category->getTranslation('name', app()->getLocale()) }}
                        </option>
                    @endforeach
                </select>
                @error('categories.*')
