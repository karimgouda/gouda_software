...
class EmployeeDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        $table =   (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $id = $query->id;
                return view('backend.employees._action', compact('id'));
            })
            ...
            ->editColumn('description', function ($query) {
                return view('backend.employees._description',compact('query'));
            })
        ...
        TranslatableService::addTranslatableColumnsToDataTable(new Employee, $table);
    ...
    public function getColumns(): array
    {
        return [
            ...
            ['name' => 'facebook_link',      'data' => 'facebook_link',  'title'=> translate('facebook_link')],
            ['name' => 'twitter_link',       'data' => 'twitter_link',  'title'=> translate('twitter_link')],
            ['name' => 'instagram_link',     'data' => 'instagram_link',  'title'=> translate('instagram_link')],
